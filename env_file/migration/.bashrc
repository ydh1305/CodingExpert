...
alias m_kernel='m -j16 ONE_SHOT_MAKEFILE=build/target/board/Android.mk bootimage 2>&1 | tee build_log.txt'
alias m_lk='make aboot -j16 2>&1 | tee build_log.txt'
alias m_factory='make factory_ramdisk -j16 2>&1 | tee build_log.txt'
...
#alias find='find -L ./ -not -path "./BUILD*" -not -path "./downloads*" -not -path "./buildhistory*"'
...
export PATH=/home/worker/bin:${PATH}

# Local env_setup for UTF-8, to fix the broken unicode problem

...
echo "================================================="
cd ~/${name}/
repolr -b lamp_n_mr2_release -m mtk/mtk-6750/171018.xml --reference=/home001/mirror/lr
repo sync -c -d -j16 --no-tags
...
choosecombo 1 mcv3_global_com 2
m -j32
#source ./build/envsetup.sh
...
echo "================================================="
cd ~/${name}/non_HLOS/
./build_target.sh mcv3_global_com
echo "================================================="
echo "build Full ........................."
echo "================================================="
cd ~/${name}/
./release_image.sh mcv3_global_com
cd ~
echo "================================================="
echo "FINISH_Build"
echo "================================================="

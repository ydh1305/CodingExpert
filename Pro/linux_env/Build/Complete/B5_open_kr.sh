...
echo "================================================="
cd ~/${name}/
repolr -b msm8952_m_mr1_b5_open_kr_mp_160726 -m B5_OPEN_KR_MP_V75509b_03_0908_factory2.xml
repo sync -c -j32
repo start msm8952_m_mr1_b5_open_kr_mp_160726 --all
...
echo "================================================="
cd ~/${name}/non_HLOS/
./build_target.sh b5_open_kr
echo "================================================="
echo "build Full ........................."
echo "================================================="
cd ~/${name}/
./release_image.sh b5_open_kr
cd ~
echo "================================================="
echo "FINISH_Build"
echo "================================================="
